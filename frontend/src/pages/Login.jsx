...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      notify({ title: 'Welcome back!', message: 'You are now logged in.', type: 'success' });
      navigate('/');
    } else {
  ...
  return (
    <div className="pt-24 pb-20 min-h-screen">
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 relative z-10">
        <SectionHeading label="Welcome Back" title="Log In" description="Log in to view your orders and track deliveries." />
        ...
        <div className="bg-surface-container rounded-3xl p-6 sm:p-8 border border-border">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Field icon={Lock} name="password" type="password" label="Password" value={form.password} onChange={handleChange} required />
